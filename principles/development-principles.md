...
If you produce something reusable, package it (e.g. with pypi or rubygems) & share it with others
All non-throwaway code should be reviewed - no-one is 100% right, 100% of the time… be aware that ‘throwaway’ code has a nasty habit of hanging about.
